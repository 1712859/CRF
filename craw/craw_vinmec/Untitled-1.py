...
f = open("C:\\Users\\ADMIN\\OneDrive - VNU-HCMUS\\Desktop\\CRF\\CRF++-0.58\\train_1.data", 'r', encoding='UTF-8')
data = f.readlines()
raed = open("C:\\Users\\ADMIN\\OneDrive - VNU-HCMUS\\Desktop\\CRF\\craw\\craw_vinmec\\error.data", 'r', encoding='UTF-8')
dataero = raed.readlines()
dataero.sort()
raedd = open("C:\\Users\\ADMIN\\OneDrive - VNU-HCMUS\\Desktop\\CRF\\craw\\craw_vinmec\\error.data", 'w', encoding='UTF-8')
for a in dataero:
    raedd.writelines(a)
...
write = open("C:\\Users\\ADMIN\\OneDrive - VNU-HCMUS\\Desktop\\CRF\\CRF++-0.58\\check.data", 'w', encoding='UTF-8')
count = 1
count2 = 1
check = []
